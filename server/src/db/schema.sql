-- FITFORGE — TiDB Cloud Enterprise Relational Database Schema
-- Optimized for Distributed MySQL/TiDB with Partitioning and Indexes

CREATE DATABASE IF NOT EXISTS fitforge_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE fitforge_db;
...
CREATE TABLE IF NOT EXISTS meal_items (
    ...
    calculated_fiber_g DECIMAL(8,2) DEFAULT 0,
